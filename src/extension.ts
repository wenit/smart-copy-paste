...
const buildCopyCutCommand = (history: History, converter: Converter,isCut = false) => {
  ...
  vscode.window
    ...
    .then((item?: ClipBoardItem) => {
      ...
      const movePastedBlockToTop = vscode.workspace
        .getConfiguration("smart-copy-paste")
